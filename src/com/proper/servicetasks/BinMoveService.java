...
//        mWorkerHandlerThread = new HandlerThread("MyServiceWorkerThread", Process.THREAD_PRIORITY_BACKGROUND);
//        mWorkerHandlerThread.start();
//        handler = new Handler(mWorkerHandlerThread.getLooper()){
//            @Override
...
//                    Log.d(TAG, "onCreated - handleMessage");
//                    e.printStackTrace();
//                }
//                doInBackground(intent);
//            }
//        };
...
//                exec.scheduleAtFixedRate(new doWorkInBackground(), 0, period, TimeUnit.MICROSECONDS);
