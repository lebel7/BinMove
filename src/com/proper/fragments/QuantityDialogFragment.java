    ...
    public void onClick(View v) {
        ...
        if (v == btnFinish) {
            if (moveItem.getQtyToMove() <= 0) {
                ...
                ((ActBinProductMain) getActivity()).setCurrentBinSelection(moveItem);    // pass data back to the activity
...
//            if (Character.isDigit(editable.)) {
//            }
//            for (Character varchar : editable.sp){
//
//            }
